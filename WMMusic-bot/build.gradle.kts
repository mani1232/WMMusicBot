...
dependencies {
    ...
    compileOnly("com.github.topi314.lavasrc:lavasrc:4.0.0-beta.7")
    compileOnly("dev.arbjerg:lavaplayer:2.0.2")
    implementation("org.bstats:bstats-base:3.0.2")
    implementation("ch.qos.logback:logback-classic:1.4.11")
    compileOnly("com.github.discord-jda:JDA:5.0.0-beta.15")
